...
const bridge = {
  ...
  assistantSpeedGet: () => ipcRenderer.invoke('aegis:settings:assistantspeed:get'),
  assistantSpeedSet: (level) => ipcRenderer.invoke('aegis:settings:assistantspeed:set', String(level)),
