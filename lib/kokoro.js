...
function ensureChild(appRoot) {
  ...
  child = proc;
  // Run below normal priority so the cold-load (model load + first synth) can't
  // starve the Electron main process and freeze the UI (see melotts). Best-effort.
...
module.exports = { synthesize, findModel, findRunner, isReady, prewarm, knobsForProfile, killEngine, setIdleMs };
