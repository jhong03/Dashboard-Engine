...
const EFFECT_TYPES = ['ripple', 'sway', 'drift-warp', 'pulse', 'cursor-ripple'];
...
const COMPONENT_SANITIZERS = {
  ...
  pomodoro(options) {
    return {
      ...
      shortBreakMin: int(options.shortBreakMin, 1, 180, 5),
      longBreakMin: int(options.longBreakMin, 1, 180, 15),
      cyclesBeforeLong: int(options.cyclesBeforeLong, 1, 12, 4),
      autoStart: bool(options.autoStart, false), // auto-advance into the next phase running
