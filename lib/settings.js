...
function load(userDir) {
  try {
    ...
    return { activePack: null, performance: { ...DEFAULT_PERFORMANCE }, backgroundMotion: { ...DEFAULT_BACKGROUND_MOTION }, displayPin: null, onboarded: false, weatherLocation: null, healthVoiceAlerts: false, locale: null, detailWidth: null, editorLayout: { pal: null, insp: null } };
  }
}
