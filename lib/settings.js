...
// UI language code (e.g. "en", "es", "zh"); null = auto (OS locale, else English).
...
function load(userDir) {
  try {
    ...
    return { activePack: null, performance: { ...DEFAULT_PERFORMANCE }, backgroundMotion: { ...DEFAULT_BACKGROUND_MOTION }, displayId: null, onboarded: false, weatherLocation: null, healthVoiceAlerts: false, locale: null };
  }
}
